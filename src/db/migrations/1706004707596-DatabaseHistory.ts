...
export class DatabaseHistory1706004707596 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "product_variant" ("id" SERIAL NOT NULL, "sku" character varying NOT NULL, "productId" integer NOT NULL, "quantity" integer NOT NULL, CONSTRAINT "PK_1ab69c9935c61f7c70791ae0a9f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "product_option_value" ("id" SERIAL NOT NULL, "name" character varying NOT NULL DEFAULT true, "optionId" integer, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "productId" integer, "variantId" integer, CONSTRAINT "PK_2ab71ed3b21be5800905c621535" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "product_option_value" ADD CONSTRAINT "FK_fab09dadca168bfb0e9eed0c3e6" FOREIGN KEY ("variantId") REFERENCES "product_variant"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "product_option_value" ADD CONSTRAINT "FK_1f611a4840fda7f7b69fa9cbe9d" FOREIGN KEY ("productId") REFERENCES "product"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "product_option_value" DROP CONSTRAINT "FK_1f611a4840fda7f7b69fa9cbe9d"`);
        await queryRunner.query(`ALTER TABLE "product_option_value" DROP CONSTRAINT "FK_fab09dadca168bfb0e9eed0c3e6"`);
